...
const ProductDetail = ({ product }: ProductDetailProps) => {
  ...
  const [, setShowFullImage] = useState(false);
  ...
  return (
    ...
    >
      <Head>
        <link rel="preload" href={product.mainImage} as="image" />
      </Head>
          ...
          >
            ...
            >
              <Link
                ...
                itemProp="item"
              >
                <span itemProp="name">Bảng Hiệu</span>
              </Link>
            ...
            <div className="relative space-y-4">
              ...
              <div className="relative aspect-[5/3] overflow-hidden rounded-lg shadow-2xl">
                <Image
                  ...
                  loading="eager"
                  onClick={() =>
                    openFullImage(product.gallery[currentImageIndex])
                  }
                />
                {/* Navigation Buttons */}
                <button
