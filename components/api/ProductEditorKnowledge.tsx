...
const ProductEditorKnowledge: React.FC<EditorProps> = ({
  EditorContent,
  onPreview,
}) => {
  const {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-8 flex items-center justify-between">
        <h1 className="text-3xl font-bold">Quản Lý Trang Kiến Thức</h1>
        <button
          onClick={() => setIsAdding(true)}
          className="flex items-center rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700"
          disabled={loading}
        >
          <FaPlus className="mr-2" /> Thêm Kiến Thức
        </button>
      </div>
...
export default ProductEditorKnowledge;
