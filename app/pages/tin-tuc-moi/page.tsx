...
const NewsPage: React.FC<EditorProps> = ({ EditorContent }) => {
  ...
  return (
    <>
      <Head>
        <title>Tin Tức Mới Nhất | Siêu Thị Bảng Hiệu</title>
        <meta
          name="description"
          content="Cập nhật tin tức mới nhất về bảng hiệu, biển quảng cáo, xu hướng thiết kế và công nghệ LED. Thông tin hữu ích cho doanh nghiệp của bạn."
        />
        <meta
          name="keywords"
          content="tin tức bảng hiệu, tin tức quảng cáo, xu hướng bảng hiệu, công nghệ LED mới"
        />
        <meta
          property="og:title"
          content="Tin Tức Mới Nhất | Siêu Thị Bảng Hiệu"
        />
        <meta
          property="og:description"
          content="Cập nhật tin tức mới nhất về bảng hiệu, biển quảng cáo, xu hướng thiết kế và công nghệ LED."
        />
        ...
        <link
          rel="canonical"
          href="https://sieuthibanghieu.vn/pages/tin-tuc-moi"
        />
      </Head>
