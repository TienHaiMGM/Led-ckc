        ...
        <div className="flex flex-col gap-8 lg:flex-row">
          ...
          <article className="prose max-w-none lg:w-3/4">
            ...
            <div className="mb-12 rounded-lg bg-gray-50 p-8">
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Tạo không gian ấm cúng với bảng hiệu gỗ cho nhà hàng và quán
                    cafe.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-xl font-semibold">Spa & Resort</h3>
                  <p className="text-gray-600">
                    Tạo điểm nhấn sang trọng với bảng hiệu gỗ cho spa và resort.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100">
                  ...
                  <h3 className="mb-2 text-xl font-semibold">Shop Organic</h3>
                  <p className="text-gray-600">
                    Thu hút khách hàng với bảng hiệu gỗ tự nhiên cho cửa hàng
                    organic.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Đội ngũ chuyên viên sẽ khảo sát địa điểm, tư vấn chất liệu
                      gỗ và phương án thiết kế phù hợp nhất.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-sm">
                ...
                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Triển khai thi công chuyên nghiệp với đội ngũ thợ mộc lành
            ...
            <div className="rounded-lg bg-blue-50 p-8">
              <h2 className="mb-6 text-2xl font-bold text-gray-800">
                Báo Giá Bảng Hiệu Gỗ
              </h2>
              <p className="mb-6 text-gray-600">
                Giá thành bảng hiệu gỗ phụ thuộc vào nhiều yếu tố khác nhau.
