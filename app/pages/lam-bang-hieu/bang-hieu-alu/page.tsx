...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Bảng Hiệu Alu - Giải Pháp Quảng Cáo Chuyên Nghiệp",
  description:
    "Tìm hiểu về bảng hiệu Alu - giải pháp quảng cáo chất lượng cao, bền đẹp và tiết kiệm chi phí cho doanh nghiệp của bạn.",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://sieuthibanghieu.vn/pages/lam-bang-hieu/bang-hieu-Alu",
  },
  about: {
    "@type": "Product",
    name: "Bảng Hiệu Alu",
    description:
      "Bảng hiệu được làm từ chất liệu Alu cao cấp, bền đẹp và tiết kiệm chi phí",
    brand: {
      "@type": "Brand",
      name: "Siêu Thị Bảng Hiệu",
    },
          ...
          <article className="prose max-w-none lg:w-3/4">
            ...
            <div className="mb-12 rounded-lg bg-gray-50 p-8">
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Tạo điểm nhấn với bảng hiệu Alu cho cửa hàng và shop thời
                    trang.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
            ...
            <div className="rounded-lg bg-blue-50 p-8">
              ...
              <p className="mb-6 text-gray-600">
                Giá thành bảng hiệu Alu phụ thuộc vào nhiều yếu tố khác nhau.
