...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Bảng Hiệu Mica - Giải Pháp Quảng Cáo Hiện Đại",
  description:
    "Tìm hiểu về bảng hiệu mica - giải pháp quảng cáo hiện đại, đa dạng màu sắc và tiết kiệm chi phí cho doanh nghiệp của bạn.",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://sieuthibanghieu.vn/pages/lam-bang-hieu/bang-hieu-mica",
  },
  about: {
    "@type": "Product",
    name: "Bảng Hiệu Mica",
    description:
      "Bảng hiệu được làm từ chất liệu mica cao cấp, đa dạng màu sắc và hiệu ứng ánh sáng",
    brand: {
      "@type": "Brand",
      name: "Siêu Thị Bảng Hiệu",
    },
