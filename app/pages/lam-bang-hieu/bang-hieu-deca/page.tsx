...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Bảng Hiệu Deca - Giải Pháp Quảng Cáo Chuyên Nghiệp",
  description:
    "Tìm hiểu về bảng hiệu deca - giải pháp quảng cáo chất lượng cao, bền đẹp và tiết kiệm chi phí cho doanh nghiệp của bạn.",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://sieuthibanghieu.vn/pages/lam-bang-hieu/bang-hieu-deca",
  },
  about: {
    "@type": "Product",
    name: "Bảng Hiệu Deca",
    description:
      "Bảng hiệu được làm từ chất liệu deca cao cấp, bền đẹp và tiết kiệm chi phí",
    brand: {
      "@type": "Brand",
      name: "Siêu Thị Bảng Hiệu",
    },
          ...
          <article className="prose max-w-none lg:w-3/4">
            <div className="mb-8 rounded-lg bg-gradient-to-r from-blue-50 to-white p-6">
              <h1 className="mb-4 text-3xl font-bold text-blue-800 lg:text-4xl">
                Bảng Hiệu Deca - Giải Pháp Quảng Cáo Chuyên Nghiệp
              </h1>
              <p className="mb-6 text-lg text-gray-600">
                Khám phá giải pháp bảng hiệu chuyên nghiệp với chất liệu deca
            ...
            <div className="mb-12 grid gap-8 lg:grid-cols-2">
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-gray-800">
                  Bảng Hiệu Deca Là Gì?
                </h2>
                <p className="text-gray-600">
                  Bảng hiệu Deca là loại bảng hiệu được làm từ chất liệu nhựa
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    Độ bền cao, chống chọi thời tiết
                  </li>
                  <li className="flex items-center">
                    <svg
                      className="mr-2 h-5 w-5 text-green-500"
            ...
            <div className="mb-12 rounded-lg bg-gray-50 p-8">
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Tạo điểm nhấn với bảng hiệu deca cho cửa hàng và shop thời
                    trang.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Tạo bảng hiệu chuyên nghiệp cho văn phòng và công ty với chi
                    phí hợp lý.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-xl font-semibold">Quảng Cáo</h3>
                  <p className="text-gray-600">
                    Sản xuất bảng hiệu quảng cáo ngoài trời với độ bền cao.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg bg-blue-50 p-8">
              <h2 className="mb-6 text-2xl font-bold text-gray-800">
                Báo Giá Bảng Hiệu Deca
              </h2>
              <p className="mb-6 text-gray-600">
                Giá thành bảng hiệu Deca phụ thuộc vào nhiều yếu tố khác nhau.
