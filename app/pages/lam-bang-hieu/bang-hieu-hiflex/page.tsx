...
const jsonLd = {
  ...
  "@type": "Article",
  headline: "Bảng Hiệu Hiflex - Giải Pháp Quảng Cáo Ngoài Trời",
  description:
    "Tìm hiểu về bảng hiệu hiflex - giải pháp quảng cáo ngoài trời hiệu quả, bền đẹp và tiết kiệm chi phí cho doanh nghiệp của bạn.",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://sieuthibanghieu.vn/pages/lam-bang-hieu/bang-hieu-hiflex",
  },
  about: {
    "@type": "Product",
    name: "Bảng Hiệu Hiflex",
    description:
      "Bảng hiệu được làm từ chất liệu hiflex cao cấp, phù hợp cho quảng cáo ngoài trời",
    brand: {
      "@type": "Brand",
      name: "Siêu Thị Bảng Hiệu",
    },
          ...
          <article className="prose max-w-none lg:w-3/4">
            <div className="mb-8 rounded-lg bg-gradient-to-r from-blue-50 to-white p-6">
              <h1 className="mb-4 text-3xl font-bold text-blue-800 lg:text-4xl">
                Bảng Hiệu Hiflex - Giải Pháp Quảng Cáo Ngoài Trời
              </h1>
              <p className="mb-6 text-lg text-gray-600">
                Khám phá giải pháp bảng hiệu ngoài trời với chất liệu hiflex cao
                cấp, bền bỉ trong mọi điều kiện thời tiết và chi phí hợp lý.
              </p>
            ...
            <div className="mb-12 grid gap-8 lg:grid-cols-2">
              <div>
                <Image
                  ...
                  alt="Bảng hiệu Hiflex chuyên nghiệp"
                  width={800}
                  height={400}
              ...
              <div className="space-y-4">
                <h2 className="text-2xl font-bold text-gray-800">
                  Bảng Hiệu Hiflex Là Gì?
                </h2>
                <p className="text-gray-600">
                  Bảng hiệu Hiflex là loại bảng hiệu sử dụng chất liệu bạt
                  hiflex cao cấp, có khả năng chống chịu thời tiết tốt, phù hợp
                  cho quảng cáo ngoài trời.
                </p>
            ...
            <div className="mb-12 rounded-lg bg-gray-50 p-8">
              ...
              <div className="grid gap-6 lg:grid-cols-3">
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Tạo bảng quảng cáo ngoài trời với kích thước lớn, bền bỉ với
                    thời tiết.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <h3 className="mb-2 text-xl font-semibold">Biển Tấm Lớn</h3>
                  <p className="text-gray-600">
                    Thiết kế và thi công biển quảng cáo tấm lớn cho các thương
                    hiệu.
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Thiết kế backdrop cho sự kiện, hội nghị với chất lượng in ấn
                    cao.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Tạo bản thiết kế chi tiết để khách hàng có cái nhìn tổng
            ...
            <div className="rounded-lg bg-blue-50 p-8">
              <h2 className="mb-6 text-2xl font-bold text-gray-800">
                Báo Giá Bảng Hiệu Hiflex
              </h2>
              <p className="mb-6 text-gray-600">
                Giá thành bảng hiệu Hiflex phụ thuộc vào nhiều yếu tố khác nhau.
