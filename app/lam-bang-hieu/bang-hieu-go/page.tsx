    ...
    "@graph": [
      {
        ...
        serviceType: "Thi công bảng hiệu gỗ",
        description:
          "Siêu Thị Bảng Hiệu cung cấp dịch vụ thiết kế và thi công bảng hiệu gỗ tinh tế, sang trọng và giá hợp lý.",
        areaServed: {
        ...
        offers: {
          ...
          url: "https://sieuthibanghieu.com/lam-bang-hieu/bang-hieu-go",
        },
      },
      {
        "@type": "Article",
        headline: "Bảng Hiệu Gỗ | Thiết Kế Sang Trọng & Độc Đáo",
        description:
          "Khám phá bảng hiệu gỗ – sự kết hợp giữa vẻ đẹp tự nhiên, sang trọng và bền bỉ. Siêu Thị Bảng Hiệu mang đến những thiết kế bảng hiệu gỗ tinh tế, đẳng cấp.",
        url: "https://sieuthibanghieu.com/lam-bang-hieu/bang-hieu-go",
        author: {
      ...
      },
      {
        ...
        mainEntity: [
          {
            "@type": "Question",
            name: "Bảng hiệu gỗ có bền không?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Bảng hiệu gỗ có độ bền từ 5-10 năm nếu được xử lý chống ẩm mốc và bảo quản đúng cách.",
            },
          },
          {
            "@type": "Question",
            name: "Chi phí làm bảng hiệu gỗ là bao nhiêu?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Chi phí dao động từ 500.000 - 15.000.000 VND tùy vào loại gỗ, kích thước và thiết kế.",
            },
          },
          {
            "@type": "Question",
            name: "Có thể khắc chữ lên bảng hiệu gỗ không?",
            acceptedAnswer: {
              "@type": "Answer",
              text: "Có, bảng hiệu gỗ có thể khắc chữ laser, khắc CNC hoặc in UV tùy vào yêu cầu thiết kế.",
            },
          },
        ],
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "Bảng Hiệu Gỗ",
            item: "https://sieuthibanghieu.com/lam-bang-hieu/bang-hieu-go",
          },
        ],
      },
    ],
